...
constexpr auto BATTLE_MUSIC_PATH  = "resources/music/battle.ogg";
constexpr auto TOWN_MUSIC_PATH    = "resources/music/town.ogg";
...
constexpr auto GRASS_PAD_FG = "resources/battle/grass_battle_fg.png";
